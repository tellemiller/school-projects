//<MoveToFrontSOL.h> - Header file to implement MTF feature of SOL
...
template <typename E>
class MoveToFrontSOL : public SelfOrderedListADT<E> {
public:

	MoveToFrontSOL() : SelfOrderedListADT<E>() {} // Constructor
	~MoveToFrontSOL() {} // Destructor
